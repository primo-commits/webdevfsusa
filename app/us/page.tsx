...
export default function UsPage() {
  ...
  useEffect(() => {
    ...
    // Also listen for the custom lang-change event (used by Navbar)
    window.addEventListener("feeslayers-lang-change", handler);
    return () => {
      window.removeEventListener("storage", handler);
      window.removeEventListener("feeslayers-lang-change", handler);
    };
  }, []);

  const t = translations[lang].us;
      ...
      <main className="flex-1 pt-16 lg:pt-20">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-cream leading-tight tracking-tight mb-6">
                {t.headlineLine1}<br />
                <span className="wordmark-slayers">{t.headlineLine2}</span><br />
                {t.headlineLine3}
              </h1>
              ...
              <div className="mt-10 inline-flex flex-col items-center gap-1">
                <div className="text-5xl font-extrabold text-gold">{t.priceAnchor}</div>
                <div className="text-cream/40 text-sm">{t.priceAnchorPeriod} · {t.priceAnchorNote}</div>
              </div>
        ...
        <section id="services" className="bg-cream-light py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {t.paymentStackServices.map((service) => (
                <div
                  key={service.title}
                  className={
                    service.featured
                ...
                >
                  <div className={
                    ...
                    {service.title === "Google Presence" && (
                      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                      </svg>
                    )}
                    {service.title === "Facebook & Meta Advertising" && (
                      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
                      </svg>
                    )}
                    {service.title === "Consumer Financing" && (
                      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {service.title === "Business Capital" && (
                      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
                      </svg>
                    )}
                    {service.title === "Clover Hardware" && (
                      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section id="how-it-works" className="section-navy py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {[
                { step: "1", title: t.howItWorksStep1Title, desc: t.howItWorksStep1Desc },
                { step: "2", title: t.howItWorksStep2Title, desc: t.howItWorksStep2Desc },
                { step: "3", title: t.howItWorksStep3Title, desc: t.howItWorksStep3Desc },
              ].map((item) => (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto text-center mb-14">
              ...
              <p className="text-cream/60 text-lg">
                {t.isThisForMeSubtitle}
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {t.isThisForMeItems.map((item) => (
        ...
        <section id="contact" className="bg-cream-light py-20">
          <div className="max-w-xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            />
            <p className="text-navy/60 text-lg mb-8" dangerouslySetInnerHTML={{ __html: t.contactSubtitle }} />
